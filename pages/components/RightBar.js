  ...
  return (
    <div className='bg-white w-4/12 rounded-xl border border-gray-100'>
      ...
      <div className='flex flex-col items-center p-3'>
        <p className='font-semibold text-lg text-gray-800'>21h 47m 51s</p>
      ...
      <div className='flex flex-col items-center p-3'>
        <p className='text-gray-600 text-sm text-center'>These are rewards available to be claimed right now.</p>
      </div>
    </div>
  )
}
